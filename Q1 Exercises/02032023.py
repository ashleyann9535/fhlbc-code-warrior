#Exercise 12 Calling in Sick
# In this exercise you will be given a few variables that will be set randomly to 
#Boolean values (True  or False ):
# actually_sick  - when you legit have the flu!
# kinda_sick  - you're feeling under the weather and it's enough to treat yoself 
#with a day off if you can spare it
...
# The tests check that the value of calling_in_sick  is correct based on the conditions 
#specified above.
...
elif kinda_sick and hate_your_job and sick_days >= 1:
    calling_in_sick = True
else:
